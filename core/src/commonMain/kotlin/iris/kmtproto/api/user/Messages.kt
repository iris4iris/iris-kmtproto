...
class Messages(
    ...
    suspend fun sendPhoto(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "photo.jpg", spoiler: Boolean = false, ttlSeconds: Int? = null, randomId: Long? = null, silent: Boolean = false, background: Boolean = false, clearDraft: Boolean = false, noforwards: Boolean = false, updateStickersetsOrder: Boolean = false, invertMedia: Boolean = false, allowPaidFloodskip: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null, entities: List<MessageEntity>? = null, scheduleDate: Int? = null, scheduleRepeatPeriod: Int? = null, sendAs: InputPeer? = null, sendAsId: Long? = null, quickReplyShortcut: InputQuickReplyShortcut? = null, effect: Long? = null, allowPaidStars: Long? = null, suggestedPost: SuggestedPost? = null): SentMessage {
        ...
        return sendMedia(peer, InputMediaUploadedPhoto(file = file, spoiler = spoiler, ttlSeconds = ttlSeconds), caption, randomId, silent, background, clearDraft, noforwards, updateStickersetsOrder, invertMedia, allowPaidFloodskip, replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod, sendAs, sendAsId, quickReplyShortcut, effect, allowPaidStars, suggestedPost)
    }
    ...
    fun sendVoiceAsync(peer: InputPeer, source: ByteSource, duration: Int = 0, fileName: String = "voice.ogg", waveform: ByteArray? = null, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
        client.apiAsync { sendVoice(peer, source, duration, fileName, waveform, caption, silent, replyTo, replyMarkup) }

    fun sendVoiceAsync(peerId: Long, bytes: ByteArray, duration: Int = 0, fileName: String = "voice.ogg", waveform: ByteArray? = null, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
    ...
    suspend fun sendVoice(peerId: Long, bytes: ByteArray, duration: Int = 0, fileName: String = "voice.ogg", waveform: ByteArray? = null, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    suspend fun sendVoice(peer: InputPeer, source: ByteSource, duration: Int = 0, fileName: String = "voice.ogg", waveform: ByteArray? = null, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    fun sendVideoNoteAsync(peer: InputPeer, source: ByteSource, duration: Double = 0.0, length: Int = 384, fileName: String = "video_note.mp4", thumb: ByteSource? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
        client.apiAsync { sendVideoNote(peer, source, duration, length, fileName, thumb, silent, replyTo, replyMarkup) }

    fun sendVideoNoteAsync(peerId: Long, bytes: ByteArray, duration: Double = 0.0, length: Int = 384, fileName: String = "video_note.mp4", thumb: ByteArray? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
    ...
    suspend fun sendVideoNote(peerId: Long, bytes: ByteArray, duration: Double = 0.0, length: Int = 384, fileName: String = "video_note.mp4", thumb: ByteArray? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    suspend fun sendVideoNote(peer: InputPeer, source: ByteSource, duration: Double = 0.0, length: Int = 384, fileName: String = "video_note.mp4", thumb: ByteSource? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    fun sendDocumentAsync(peer: InputPeer, source: ByteSource, fileName: String, caption: String = "", mimeType: String? = null, thumb: ByteSource? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
        client.apiAsync { sendDocument(peer, source, fileName, caption, mimeType, thumb, silent, replyTo, replyMarkup) }

    fun sendDocumentAsync(peerId: Long, bytes: ByteArray, fileName: String, caption: String = "", mimeType: String? = null, thumb: ByteArray? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
    ...
    suspend fun sendDocument(peerId: Long, bytes: ByteArray, fileName: String, caption: String = "", mimeType: String? = null, thumb: ByteArray? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    suspend fun sendDocument(peer: InputPeer, source: ByteSource, fileName: String, caption: String = "", mimeType: String? = null, thumb: ByteSource? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    fun sendGifAsync(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteSource? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
        client.apiAsync { sendGif(peer, source, caption, fileName, duration, width, height, thumb, spoiler, silent, replyTo, replyMarkup) }

    fun sendGifAsync(peerId: Long, bytes: ByteArray, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteArray? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<SentMessage> =
    ...
    suspend fun sendGif(peerId: Long, bytes: ByteArray, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteArray? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    suspend fun sendGif(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteSource? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): SentMessage =
    ...
    private suspend fun sendUploadedDocument(peer: InputPeer, source: ByteSource, fileName: String, mimeType: String, attributes: List<DocumentAttribute>, caption: String, thumb: ByteSource?, forceFile: Boolean, spoiler: Boolean, ttlSeconds: Int?, randomId: Long?, silent: Boolean, background: Boolean, clearDraft: Boolean, noforwards: Boolean, updateStickersetsOrder: Boolean, invertMedia: Boolean, allowPaidFloodskip: Boolean, replyTo: InputReplyTo?, replyMarkup: ReplyMarkup?, entities: List<MessageEntity>?, scheduleDate: Int?, scheduleRepeatPeriod: Int?, sendAs: InputPeer?, sendAsId: Long?, quickReplyShortcut: InputQuickReplyShortcut?, effect: Long?, allowPaidStars: Long?, suggestedPost: SuggestedPost?): SentMessage {
        ...
        return sendMedia(peer, InputMediaUploadedDocument(file = file, mimeType = mimeType, attributes = attributes, forceFile = forceFile, spoiler = spoiler, thumb = thumbFile, ttlSeconds = ttlSeconds), caption, randomId, silent, background, clearDraft, noforwards, updateStickersetsOrder, invertMedia, allowPaidFloodskip, replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod, sendAs, sendAsId, quickReplyShortcut, effect, allowPaidStars, suggestedPost)
    }
