...
class Messages(
    ...
    suspend fun sendPhoto(
        ...
        peer = peer,
        source = ByteArrayByteSource(bytes),
        caption = caption,
        fileName = fileName,
        spoiler = spoiler,
        ttlSeconds = ttlSeconds,
    ...
    fun sendPhotoAsync(
        ...
        sendPhoto(
            peer, source, caption, fileName, spoiler, ttlSeconds, randomId, silent, background,
            clearDraft, noforwards, updateStickersetsOrder, invertMedia, allowPaidFloodskip,
            replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod, sendAs, sendAsId,
            quickReplyShortcut, effect, allowPaidStars, suggestedPost,
        )
    ...
    fun sendPhotoAsync(
        ...
        sendPhoto(
            peerId, source, caption, fileName, spoiler, ttlSeconds, randomId, silent, background,
            clearDraft, noforwards, updateStickersetsOrder, invertMedia, allowPaidFloodskip,
            replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod, sendAs, sendAsId,
            quickReplyShortcut, effect, allowPaidStars, suggestedPost,
        )
    ...
    suspend fun sendVideo(
        ...
        width = width,
        height = height,
        thumb = thumb?.let { ByteArrayByteSource(it) },
        supportsStreaming = supportsStreaming,
        roundMessage = roundMessage,
        nosound = nosound,
        spoiler = spoiler,
    ...
    fun sendVideoAsync(
        ...
        sendVideo(
            peer, source, caption, fileName, mimeType, duration, width, height, thumb,
            supportsStreaming, roundMessage, nosound, spoiler, ttlSeconds, randomId, silent,
            background, clearDraft, noforwards, updateStickersetsOrder, invertMedia,
            allowPaidFloodskip, replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod,
            sendAs, sendAsId, quickReplyShortcut, effect, allowPaidStars, suggestedPost,
    ...
    fun sendVideoAsync(
        ...
        sendVideo(
            peerId, source, caption, fileName, mimeType, duration, width, height, thumb,
            supportsStreaming, roundMessage, nosound, spoiler, ttlSeconds, randomId, silent,
            background, clearDraft, noforwards, updateStickersetsOrder, invertMedia,
            allowPaidFloodskip, replyTo, replyMarkup, entities, scheduleDate, scheduleRepeatPeriod,
            sendAs, sendAsId, quickReplyShortcut, effect, allowPaidStars, suggestedPost,
    ...
    suspend fun sendVoice(
        ...
        peer, ByteArrayByteSource(bytes), duration, fileName, waveform, caption, silent, replyTo, replyMarkup,
    )
    ...
    fun sendVoiceAsync(
        ...
        sendVoice(peer, source, duration, fileName, waveform, caption, silent, replyTo, replyMarkup)
    }
    ...
    fun sendVoiceAsync(
        ...
        sendVoice(peerId, source, duration, fileName, waveform, caption, silent, replyTo, replyMarkup)
    }
    ...
    suspend fun sendVoice(
        ...
        client.inputPeerFromId(peerId), source, duration, fileName, waveform, caption, silent, replyTo, replyMarkup,
    )
    ...
    suspend fun sendVideoNote(
        ...
        peer, ByteArrayByteSource(bytes), duration, length, fileName,
        thumb?.let { ByteArrayByteSource(it) }, silent, replyTo, replyMarkup,
    )
    ...
    fun sendVideoNoteAsync(
        ...
        sendVideoNote(peer, source, duration, length, fileName, thumb, silent, replyTo, replyMarkup)
    }
    ...
    fun sendVideoNoteAsync(
        ...
        sendVideoNote(peerId, source, duration, length, fileName, thumb, silent, replyTo, replyMarkup)
    }
    ...
    suspend fun sendVideoNote(
        ...
        client.inputPeerFromId(peerId), source, duration, length, fileName, thumb, silent, replyTo, replyMarkup,
    )
    ...
    suspend fun sendDocument(
        ...
        peer, ByteArrayByteSource(bytes), fileName, caption, mimeType,
        thumb?.let { ByteArrayByteSource(it) }, silent, replyTo, replyMarkup,
    )
    ...
    fun sendDocumentAsync(
        ...
        sendDocument(peer, source, fileName, caption, mimeType, thumb, silent, replyTo, replyMarkup)
    }
    ...
    fun sendDocumentAsync(
        ...
        sendDocument(peerId, source, fileName, caption, mimeType, thumb, silent, replyTo, replyMarkup)
    }
    ...
    suspend fun sendDocument(
        ...
        client.inputPeerFromId(peerId), source, fileName, caption, mimeType, thumb, silent, replyTo, replyMarkup,
    )
    ...
    suspend fun sendGif(
        ...
        peer, ByteArrayByteSource(bytes), caption, fileName, duration, width, height,
        thumb?.let { ByteArrayByteSource(it) }, spoiler, silent, replyTo, replyMarkup,
    )
    ...
    fun sendGifAsync(
        ...
        sendGif(peer, source, caption, fileName, duration, width, height, thumb, spoiler, silent, replyTo, replyMarkup)
    }
    ...
    fun sendGifAsync(
        ...
        sendGif(peerId, source, caption, fileName, duration, width, height, thumb, spoiler, silent, replyTo, replyMarkup)
    }
    ...
    suspend fun sendGif(
        ...
        client.inputPeerFromId(peerId), source, caption, fileName, duration, width, height, thumb,
        spoiler, silent, replyTo, replyMarkup,
    )
