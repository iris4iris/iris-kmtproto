...
class BotApi(val client: TelegramClient) {
    ...
    fun sendPhotoAsync(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "photo.jpg", spoiler: Boolean = false, ttlSeconds: Int? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendPhoto(peer, source, caption, fileName, spoiler, ttlSeconds, silent, replyTo, replyMarkup) }

    fun sendPhotoAsync(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "photo.jpg", spoiler: Boolean = false, ttlSeconds: Int? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendPhoto(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "photo.jpg", spoiler: Boolean = false, ttlSeconds: Int? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
    ...
    suspend fun sendPhoto(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "photo.jpg", spoiler: Boolean = false, ttlSeconds: Int? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
    ...
    fun sendVideoAsync(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "video.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteSource? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendVideo(peer, source, caption, fileName, duration, width, height, thumb, spoiler, silent, replyTo, replyMarkup) }

    fun sendVideoAsync(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "video.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteArray? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendVideo(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "video.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteArray? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
    ...
    suspend fun sendVideo(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "video.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, thumb: ByteSource? = null, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
    ...
    fun sendVoiceAsync(peer: InputPeer, source: ByteSource, duration: Int = 0, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendVoice(peer, source, duration, caption, silent, replyTo, replyMarkup) }

    fun sendVoiceAsync(chatId: Long, bytes: ByteArray, duration: Int = 0, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendVoice(chatId: Long, bytes: ByteArray, duration: Int = 0, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
        sendVoice(client.inputPeerFromId(chatId), ByteArrayByteSource(bytes), duration, caption, silent, replyTo, replyMarkup)

    suspend fun sendVoice(peer: InputPeer, source: ByteSource, duration: Int = 0, caption: String = "", silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
        user.messages.sendVoice(peer, source, duration, caption = caption, silent = silent, replyTo = replyTo, replyMarkup = replyMarkup)

    fun sendVideoNoteAsync(peer: InputPeer, source: ByteSource, duration: Double = 0.0, length: Int = 384, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendVideoNote(peer, source, duration, length, silent, replyTo, replyMarkup) }

    fun sendVideoNoteAsync(chatId: Long, bytes: ByteArray, duration: Double = 0.0, length: Int = 384, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendVideoNote(chatId: Long, bytes: ByteArray, duration: Double = 0.0, length: Int = 384, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
        sendVideoNote(client.inputPeerFromId(chatId), ByteArrayByteSource(bytes), duration, length, silent, replyTo, replyMarkup)

    suspend fun sendVideoNote(peer: InputPeer, source: ByteSource, duration: Double = 0.0, length: Int = 384, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
        user.messages.sendVideoNote(peer, source, duration, length, silent = silent, replyTo = replyTo, replyMarkup = replyMarkup)

    fun sendDocumentAsync(peer: InputPeer, source: ByteSource, fileName: String, caption: String = "", mimeType: String? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendDocument(peer, source, fileName, caption, mimeType, silent, replyTo, replyMarkup) }

    fun sendDocumentAsync(chatId: Long, bytes: ByteArray, fileName: String, caption: String = "", mimeType: String? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendDocument(chatId: Long, bytes: ByteArray, fileName: String, caption: String = "", mimeType: String? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
    ...
    suspend fun sendDocument(peer: InputPeer, source: ByteSource, fileName: String, caption: String = "", mimeType: String? = null, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
        user.messages.sendDocument(peer, source, fileName, caption, mimeType, silent = silent, replyTo = replyTo, replyMarkup = replyMarkup)

    fun sendGifAsync(peer: InputPeer, source: ByteSource, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
        client.apiAsync { sendGif(peer, source, caption, fileName, duration, width, height, spoiler, silent, replyTo, replyMarkup) }

    fun sendGifAsync(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): Deferred<RpcResponse<SentMessage>> =
    ...
    suspend fun sendGif(chatId: Long, bytes: ByteArray, caption: String = "", fileName: String = "animation.mp4", duration: Double = 0.0, width: Int = 0, height: Int = 0, spoiler: Boolean = false, silent: Boolean = false, replyTo: InputReplyTo? = null, replyMarkup: ReplyMarkup? = null): RpcResponse<SentMessage> =
